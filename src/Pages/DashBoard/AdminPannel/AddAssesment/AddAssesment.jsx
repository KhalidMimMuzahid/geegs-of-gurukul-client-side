...
const AddAssesment = () => {
  ...
  const onSubmit = (data) => {
    ...
    fetch("http://3.84.19.169:5000/api/v1/assessments/add-assesment", {
      method: "POST",
      headers: {
  ...
  useEffect(() => {
    ...
    fetch("http://3.84.19.169:5000/api/v1/questions/get-questions", {
      headers: {
        "content-type": "application/json",
  ...
  //   }
  //   // console.log(" assesment : ", assesment);
  //   fetch("http://3.84.19.169:5000/api/v1/questions/add-assesment", {
  //     method: "POST",
  //     headers: {
  //       "content-type": "application/json",
  //     },
